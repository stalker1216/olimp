...
class Menu(Screen):
    ...
    def __init__(self, **kw):
        ...
        self.go_task_button=Button(size_hint=[1,1],background_normal=path+"sprites/1.png",background_down=path+"sprites/task_off.jpg",color=[0,0,0,1],on_press=self.go_task)
        ...
        self.go_calendar_button=Button(size_hint=[1,1],background_normal=path+"sprites/2.jpg",background_down=path+"sprites/task_off.jpg",color=[0,0,0,1],on_press=self.go_calendar)
        ...
        self.go_command_button=Button(size_hint=[1,1],background_normal=path+"sprites/3.png",background_down=path+"sprites/task_off.jpg",color=[0,0,0,1],on_press=self.go_command)
        ...
        self.go_daybook_button=Button(size_hint=[1,1],background_normal=path+"sprites/4.jpg",background_down=path+"sprites/task_off.jpg",color=[0,0,0,1],on_press=self.go_daybook)
        ...
        self.go_chat_button=Button(size_hint=[1,1],background_normal=path+"sprites/5.png",background_down=path+"sprites/task_off.jpg",color=[0,0,0,1],on_press=self.go_chat)
